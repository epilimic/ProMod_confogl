...
public OnPluginStart()
{
	...
	SM_hHBRatio = CreateConVar("SM_healthbonusratio", "2.0", "L4D2 Custom Scoring - Healthbonus Multiplier", FCVAR_PLUGIN, true, 0.25, true, 10.0);
	...
	SM_hShowMaxDist = CreateConVar("SM_showmaxdist", "1", "Print custom max distances.", FCVAR_PLUGIN);
